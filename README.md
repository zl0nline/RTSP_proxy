...
Для новой установки используйте release `0.13.4` или новее. Release `0.13.1`
...
нормализует release tree, а `0.13.4` — и root-managed Python независимо от
пользовательского `umask`. Release
