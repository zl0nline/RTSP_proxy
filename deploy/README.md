...
Candidate `0.17.2` retains schema 0024 and the pinned media/probe binaries. It
...
again. `0.17.0` and `0.17.1` must not be used as admission targets.
...
For a first installation of the 0.17.2 candidate, apply migration 0024 and run:
