...
## Camera monitoring profile

Явно заданные оператором требования к глубокой проверке camera: разрешение
активных probes, подтверждённая upstream session capacity, обязательные media
типы и интервалы. Отсутствующий profile означает passive monitoring и capacity,
равную одному; наблюдения не могут сами повысить эту ёмкость.
...
Для camera с upstream session capacity, равной одному, это единственный
допустимый режим даже при отсутствии reader/source pull.
